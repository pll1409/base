...
-- infos
-----------------------------------------------------------------------------------------------------------------------------------------
vRP.prepare("vRP/create_user","INSERT INTO vrp_users(license, id) VALUES(@license, @id)")
vRP.prepare("vRP/create_characters","INSERT INTO vrp_users(license, id) VALUES(@license, @id)")
vRP.prepare("vRP/get_vrp_infos","SELECT * FROM vrp_users WHERE license = @license")
vRP.prepare("vRP/verify_chars", "SELECT chars FROM vrp_users WHERE license = @license")
